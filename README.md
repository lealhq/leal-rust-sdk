...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Flealhq%2Fleal-rust-sdk)
[![crates.io shield](https://img.shields.io/crates/v/leal)](https://crates.io/crates/leal)
...
A full reference for this library is available [here](https://github.com/lealhq/leal-rust-sdk/blob/HEAD/./reference.md).
...
```rust
match client.customer_cards.stamp(None)?.await {
    Ok(response) => {
...
let request = UpdateStoresRequest {
    ...
};
```
...
```rust
let response = client.customer_cards.stamp(
