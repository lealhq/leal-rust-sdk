...
impl GetCardsResponseBuilder {
    ...
    /// - [`auxiliary_fields`](GetCardsResponseBuilder::auxiliary_fields)
    ...
    /// - [`expires_at`](GetCardsResponseBuilder::expires_at)
    ...
    /// - [`show_member_field`](GetCardsResponseBuilder::show_member_field)
    /// - [`show_stamps_to_reward_field`](GetCardsResponseBuilder::show_stamps_to_reward_field)
    ...
    /// - [`strip_opacity`](GetCardsResponseBuilder::strip_opacity)
