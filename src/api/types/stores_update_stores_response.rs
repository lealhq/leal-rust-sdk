...
pub struct UpdateStoresResponse {
...
impl UpdateStoresResponse {
    pub fn builder() -> UpdateStoresResponseBuilder {
        <UpdateStoresResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateStoresResponseBuilder {
...
impl UpdateStoresResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateStoresResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`cards_count`](UpdateStoresResponseBuilder::cards_count)
    /// - [`created_at`](UpdateStoresResponseBuilder::created_at)
    /// - [`customers_count`](UpdateStoresResponseBuilder::customers_count)
    /// - [`display_store_name`](UpdateStoresResponseBuilder::display_store_name)
    /// - [`id`](UpdateStoresResponseBuilder::id)
    /// - [`locations_count`](UpdateStoresResponseBuilder::locations_count)
    /// - [`name`](UpdateStoresResponseBuilder::name)
    /// - [`personal`](UpdateStoresResponseBuilder::personal)
    /// - [`posters_count`](UpdateStoresResponseBuilder::posters_count)
    /// - [`store_name`](UpdateStoresResponseBuilder::store_name)
    /// - [`updated_at`](UpdateStoresResponseBuilder::updated_at)
    pub fn build(self) -> Result<UpdateStoresResponse, BuildError> {
        Ok(UpdateStoresResponse {
            cards_count: self
                .cards_count
