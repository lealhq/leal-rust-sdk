...
pub struct GetCustomerCardsResponse {
    /// Parent store ID
    #[serde(default)]
    pub account_id: i64,
...
impl GetCustomerCardsResponse {
    pub fn builder() -> GetCustomerCardsResponseBuilder {
        <GetCustomerCardsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetCustomerCardsResponseBuilder {
...
impl GetCustomerCardsResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`GetCustomerCardsResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`account_id`](GetCustomerCardsResponseBuilder::account_id)
    /// - [`apple_wallet_url`](GetCustomerCardsResponseBuilder::apple_wallet_url)
    /// - [`available_rewards`](GetCustomerCardsResponseBuilder::available_rewards)
    /// - [`card_id`](GetCustomerCardsResponseBuilder::card_id)
    /// - [`card_name`](GetCustomerCardsResponseBuilder::card_name)
    /// - [`created_at`](GetCustomerCardsResponseBuilder::created_at)
    /// - [`customer_id`](GetCustomerCardsResponseBuilder::customer_id)
    /// - [`google_wallet_url`](GetCustomerCardsResponseBuilder::google_wallet_url)
    /// - [`id`](GetCustomerCardsResponseBuilder::id)
    /// - [`issued_at`](GetCustomerCardsResponseBuilder::issued_at)
    /// - [`pass_installed`](GetCustomerCardsResponseBuilder::pass_installed)
    /// - [`progress_percentage`](GetCustomerCardsResponseBuilder::progress_percentage)
    /// - [`stamps_count`](GetCustomerCardsResponseBuilder::stamps_count)
    /// - [`stamps_remaining`](GetCustomerCardsResponseBuilder::stamps_remaining)
    /// - [`status`](GetCustomerCardsResponseBuilder::status)
    /// - [`updated_at`](GetCustomerCardsResponseBuilder::updated_at)
    /// - [`uuid`](GetCustomerCardsResponseBuilder::uuid)
    pub fn build(self) -> Result<GetCustomerCardsResponse, BuildError> {
        Ok(GetCustomerCardsResponse {
            account_id: self
                .account_id
