...
impl UpdatePostersResponse {
    pub fn builder() -> UpdatePostersResponseBuilder {
        <UpdatePostersResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdatePostersResponseBuilder {
...
impl UpdatePostersResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdatePostersResponse`].
    ...
    /// - [`title`](UpdatePostersResponseBuilder::title)
    /// - [`updated_at`](UpdatePostersResponseBuilder::updated_at)
    pub fn build(self) -> Result<UpdatePostersResponse, BuildError> {
        Ok(UpdatePostersResponse {
            account_id: self
                .account_id
