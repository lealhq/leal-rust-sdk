...
impl GetStoresResponse {
    pub fn builder() -> GetStoresResponseBuilder {
        <GetStoresResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetStoresResponseBuilder {
...
impl GetStoresResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`GetStoresResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`cards_count`](GetStoresResponseBuilder::cards_count)
    /// - [`created_at`](GetStoresResponseBuilder::created_at)
    /// - [`customers_count`](GetStoresResponseBuilder::customers_count)
    /// - [`display_store_name`](GetStoresResponseBuilder::display_store_name)
    /// - [`id`](GetStoresResponseBuilder::id)
    /// - [`locations_count`](GetStoresResponseBuilder::locations_count)
    /// - [`name`](GetStoresResponseBuilder::name)
    /// - [`personal`](GetStoresResponseBuilder::personal)
    /// - [`posters_count`](GetStoresResponseBuilder::posters_count)
    /// - [`store_name`](GetStoresResponseBuilder::store_name)
    /// - [`updated_at`](GetStoresResponseBuilder::updated_at)
    pub fn build(self) -> Result<GetStoresResponse, BuildError> {
        Ok(GetStoresResponse {
            cards_count: self
                .cards_count
