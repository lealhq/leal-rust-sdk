...
impl CreatePostersResponseBuilder {
    ...
    /// - [`collect_email`](CreatePostersResponseBuilder::collect_email)
    /// - [`collect_phone`](CreatePostersResponseBuilder::collect_phone)
    /// - [`contact_collection_mode`](CreatePostersResponseBuilder::contact_collection_mode)
    ...
    /// - [`minimum_age`](CreatePostersResponseBuilder::minimum_age)
    ...
    /// - [`require_birthday`](CreatePostersResponseBuilder::require_birthday)
    /// - [`require_email`](CreatePostersResponseBuilder::require_email)
    /// - [`require_phone`](CreatePostersResponseBuilder::require_phone)
