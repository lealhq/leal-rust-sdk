...
impl GetCustomersResponse {
    pub fn builder() -> GetCustomersResponseBuilder {
        <GetCustomersResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetCustomersResponseBuilder {
...
impl GetCustomersResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`GetCustomersResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`account_id`](GetCustomersResponseBuilder::account_id)
    /// - [`birthday`](GetCustomersResponseBuilder::birthday)
    /// - [`created_at`](GetCustomersResponseBuilder::created_at)
    /// - [`customer_cards`](GetCustomersResponseBuilder::customer_cards)
    /// - [`email`](GetCustomersResponseBuilder::email)
    /// - [`external_references`](GetCustomersResponseBuilder::external_references)
    /// - [`first_name`](GetCustomersResponseBuilder::first_name)
    /// - [`id`](GetCustomersResponseBuilder::id)
    /// - [`last_name`](GetCustomersResponseBuilder::last_name)
    /// - [`metadata`](GetCustomersResponseBuilder::metadata)
    /// - [`phone`](GetCustomersResponseBuilder::phone)
    /// - [`stamp_count`](GetCustomersResponseBuilder::stamp_count)
    /// - [`updated_at`](GetCustomersResponseBuilder::updated_at)
    pub fn build(self) -> Result<GetCustomersResponse, BuildError> {
